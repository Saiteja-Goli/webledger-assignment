...
recipe_router.get("/", async (req, res) => {
  try {
    ...
    const api_url = `https://api.spoonacular.com/recipes/random?apiKey=fc8138ca53854bb8808b2727d5b960e6&number=50`;
...
recipe_router.post("/search", async (req, res) => {
  try {
    ...
    const url = `https://api.spoonacular.com/recipes/complexSearch?apiKey=fc8138ca53854bb8808b2727d5b960e6&query=${searchValue}`;
